...
Hosted OpenAI LLM = selected reasoning backend
...
Hosted LLM calls may receive task context, but never raw API keys, OAuth tokens, signing keys, or private webhook secrets.
