...
gated-adapter client helper validation: 59 focused tests passed; ComfyUI, GitHub, Publishing adapter tests, and Publishing Agent redaction tests share deterministic fake clients and guard against local mock-client class definitions
