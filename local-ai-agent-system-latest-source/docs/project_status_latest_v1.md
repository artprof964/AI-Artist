...
test path helper validation: adapter/connector, domain, core, remaining simple, GitHub adapter, and connection settings contract checks plus existing guard tests passed; migrated checked-in backend/source inspections share test path/source helpers
