...
OpenClaw hook helper validation: 7 focused tests passed, 1 warning; OpenClaw safety hook tests share recording Safety Service client, recording adapter, mock orchestration adapter, and event labels through tests/openclaw_hook_helpers.py
...
final pytest: 539 passed, 1 warning
