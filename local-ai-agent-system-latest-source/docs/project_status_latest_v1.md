...
Connection settings and runtime env resolution: centralized in backend/connection_settings.py
...
Connection registry and runtime env resolution: shared across LLM smoke tests, GitHub adapter, readiness validation, docs, and tracker
...
final pytest: 255 passed, 1 skipped, 1 warning
