...
test path helper validation: adapter/connector, domain, core, remaining simple, and GitHub adapter contract checks plus existing guard tests passed; migrated checked-in backend/source inspections share test path/source helpers
