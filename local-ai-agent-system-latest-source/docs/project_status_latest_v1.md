...
Repository artifact paths: centralized in backend/repo_paths.py
...
Repository artifact paths: shared across security review, scaffold, OPA, and readiness validators
...
Repository paths: shared across Compose, env, runbook, OPA policy, and PostgreSQL schema file lookups
...
repo path validation: 2 passed; Compose, env, runbook, OPA policy, and PostgreSQL schema paths centralized
final pytest: 380 passed, 1 skipped, 1 warning
