...
gated-adapter client/harness helper validation: 58 focused GitHub connection-path tests passed; GitHub adapter tests share deterministic fake clients plus token/env adapter setup through tests/gated_adapter_helpers.py and guard against direct GitHubAdapter construction
