...
Test project-root resolution, checked-in project text reads, backend source reads, test source reads, repo-wide test-module source iteration, and gated-adapter execution-envelope construction: centralized in tests/path_helpers.py and tests/execution_envelope_helpers.py
