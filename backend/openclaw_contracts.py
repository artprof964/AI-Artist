...
OPENCLAW_REQUEST_KIND_FIELD = REQUEST_KIND_FIELD
OPENCLAW_REQUESTER_SCOPE_FIELD = REQUESTER_SCOPE_FIELD
OPENCLAW_POLICY_SCOPE_FIELD = POLICY_SCOPE_FIELD
OPENCLAW_REASON_FIELD = REASON_FIELD
OPENCLAW_POLICY_VERSION_FIELD = POLICY_VERSION_FIELD
OPENCLAW_REQUIRES_HUMAN_APPROVAL_FIELD = REQUIRES_HUMAN_APPROVAL_FIELD
