...
Final validation: 454 passed, 1 skipped, 1 warning
...
and summary vocabulary must flow through backend/knowledge_contracts.py before
retrieval-specific behavior is changed.
